from app import db, User, Post, Community, client
# Make sure to import community_interest_association if you're using it
from app import community_interest_association
